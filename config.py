...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6332063886:AAHKIepCN8O1V5LQp1LgSljQJn5PL8vSBLk")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "RSuploader_bot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "9976721"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "3ef17a8cdb938335bd8ba292e6d816aa")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "5838674798")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://mytoons:mytoons@cluster0.10jhfvi.mongodb.net/?retryWrites=true&w=majority")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1001930913574")) # your log channel id and make bot admin in log channel with full right 
    ...
    TECH_VJ_API = environ.get('TECH_VJ_API', '8a04025f212aa7c29f79bb1c2ac28300e149a7e0') # your url shortner api
