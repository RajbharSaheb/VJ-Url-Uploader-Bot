...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "6118468091:AAGuLOPSDsN-YPIRQLZNIE_YVShR7jMejkA")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "d4devil_bot") # Bot username without @.
